    ...
    <div className="navbar shadow-sm bg-[#FFFFFF] md:py-5 md:px-12 md:rounded-2xl">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex="-1"
            className="menu menu-sm dropdown-content bg-base-100 rounded-box z-2 mt-3 w-52 p-2 shadow text-[16px] font-medium flex items-start gap-2 text-secondary"
          >
            {navLinks}
          </ul>
        </div>
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal gap-4 text-[16px] font-medium text-secondary flex items-center">
          {navLinks}
        </ul>
      </div>
